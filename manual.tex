...
%		 TeXer:    pdflatex
%
%        Last modification on 24-Feb-2024 by KE
%
% *****************************************************************************
...
\item\textttz{qrcode} -- balíček, který umožňuje sázet QR kódy různých typů; v~šabloně je využit pro (nepovinné)
...
\end{enumerate}
Detailní informace ke všem balíčkům lze načerpat z~jejich (obvykle velmi podrobných) dokumentací, které se všechny nachází v~archivu zvaném \emph{CTAN}, tedy \emph{Comprehensive \TeX{} Archive Network}, na adrese URL \url{https://www.ctan.org}.
